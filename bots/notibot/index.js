...
function extractBracketedMessage(text) {
  ...
  if (targetGuild) {
    ...
    if (defaultRoleName === 'Hạt Giống' || lowerContent.includes('saguaro') ||
      ...
      const plantNameMap = {
        ...
        'pumpkin': 'pumpkin',
        'bingo': 'pumpkin',
         'cà rốt mặt trăng': 'moon_carrot',
         'ca rot mat trang': 'moon_carrot',
         'moon carrot': 'moon_carrot',
         'moon_carrot': 'moon_carrot',
         'carrot': 'moon_carrot',
         'carot': 'moon_carrot',
        'dừa': 'coconut',
        'coconut': 'coconut',
    ...
    if (defaultRoleName === 'Thời Tiết') {
      ...
      const detectedWeather = weatherDetectionOrder.find(([weatherName]) =>
        weatherContent.includes(weatherName)
      );
      if (detectedWeather) {
        const weaKey = detectedWeather[1];
        let weaRoleId = null;
